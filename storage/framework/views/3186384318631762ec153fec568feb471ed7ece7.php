...
<html lang="en">
  <head>
    ...
    <!-- MyCSS -->
    <link rel="stylesheet" href="<?php echo e(asset('libraries/css/main.css')); ?>" />
    ...
    <header class="section-header">
      <div class="container">
        <div class="text-center">
          <img src="<?php echo e(asset('libraries/image/pp.jpg')); ?>" class="img-fluid rounded-circle border border-5 mb-3" style="margin-top: 165px;" width="200" alt="">
          <h5 class="nama"><?php echo e($profil->nama); ?></h5>
          <p class="pekerjaan"><?php echo e($profil->pekerjaan_utama); ?> | <?php echo e($profil->pekerjaan_sampingan); ?></p>
        </div>
      </div>
    </header>
          ...
          <div class="row">
            ...
            <div class="col-md-12 mt-4 d-flex justify-content-center">
              <div class="col-lg-8 d-flex justify-content-center">
                <p class="about-me">
                  <?php echo e($profil->tentang_saya); ?>
            ...
            <?php $__currentLoopData = $pendidikans; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $pendidikan): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                ...
                <div class="row">
                  ...
                  <div class="col py-2">
                    <div class="card">
                      <div class="card-body">
                        <div class="float-end"><?php echo e($pendidikan->tahun_mulai); ?> - <?php echo e($pendidikan->tahun_lulus); ?></div>
                        <h4 class="card-title text-muted"><?php echo e($pendidikan->nama_institut); ?></h4>
                      </div>
                    </div>
                  </div>
                </div>
        ...
        <div class="container">
          <div class="row">
            ...
            <div class="col-md-4 text-center mb-5">
              ...
              <div>
                <a href="<?php echo e($profil->whatsapp); ?>" class="text-decoration-none"><img src="<?php echo e(asset('/libraries/image/wa.png')); ?>" class="img-fluid mx-1" width="50" alt=""></a>
                <a href="<?php echo e($profil->instagram); ?>" class="text-decoration-none"><img src="<?php echo e(asset('/libraries/image/instagram.png')); ?>" class="img-fluid mx-1" width="50" alt=""></a>
                <a href="<?php echo e($profil->facebook); ?>" class="text-decoration-none"><img src="<?php echo e(asset('/libraries/image/facebook.png')); ?>" class="img-fluid mx-1" width="50" alt=""></a>
                <a href="<?php echo e($profil->email); ?>" class="text-decoration-none"><img src="<?php echo e(asset('/libraries/image/tiktok.png')); ?>" class="img-fluid mx-1" width="50" alt=""></a>
              </div>
            </div>
            <div class="col-md-4 text-center mb-5">
              <h5 class="alamat">PESAN SINGKAT</h5>
              <p>
                <?php echo e($profil->pesan_singkat); ?>
...
<?php /**PATH C:\laragon\www\joki\portofolio-herlina\resources\views/index.blade.php ENDPATH**/ ?>