    ...
    <div class="row">
        <div class="col-md-12 d-flex justify-content-center">
            <div class="text-center col-3 d-flex justify-content-center mt-5 border border-3 border-light bg-light" style="border-radius: 20px">
                <div class="my-5">
                    <h5 class="fw-bold">Halaman Register</h5>
                    <form action="/daftar" method="POST">
                        <?php echo csrf_field(); ?>
                        <div class="mb-3 mt-4">
                            <label for="inputUsername" class="fw-bold">name</label>
...
</html><?php /**PATH C:\laragon\www\joki\portofolio-herlina\resources\views/register.blade.php ENDPATH**/ ?>